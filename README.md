...
th main.lua -env rlenvs.Kulbabu -modelBody models.Kulbabu -height 1 -width 8 -duel true -doubleQ true -bootstraps 0 -memPriority rank -alpha 0.7 -betaZero 0.5 -PALpha 0 -gradClip 0
...
th main.lua -async A3C -entropyBeta 0.001 -eta 0.0007 -momentum 0.99 -bootstraps 0 -batchSize 5 -hiddenSize 128 -doubleQ false -duel false -optimiser adam -steps 15000000 -tau 4 -memSize 20000 -epsilonSteps 10000 -valFreq 10000 -valSteps 6000 -bootstraps 0 -PALpha 0 -height 1 -width 8 -threads 4 -env rlenvs.Kulbabu -modelBody models.Kulbabu
```
